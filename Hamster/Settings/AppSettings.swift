...
public class HamsterAppSettings: ObservableObject {
  ...
  // 按键气泡
  @Published
  var showKeyPressBubble: Bool = UserDefaults.hamsterSettingsDefault.bool(
    forKey: HamsterAppSettingKeys.showKeyPressBubble.rawValue)
  {
    didSet {
  ...
  // 简繁切换
  @Published
  var switchTraditionalChinese: Bool = UserDefaults.hamsterSettingsDefault.bool(
    forKey: HamsterAppSettingKeys.switchTraditionalChinese.rawValue)
  {
    didSet {
      UserDefaults.hamsterSettingsDefault.set(
  ...
  // 空格滑动
  @Published
  var slideBySapceButton: Bool = UserDefaults.hamsterSettingsDefault.bool(
    forKey: HamsterAppSettingKeys.slideBySpaceButton.rawValue)
  {
    didSet {
      UserDefaults.hamsterSettingsDefault.set(
  ...
  var rimeInputSchema: String =
    UserDefaults.hamsterSettingsDefault.string(
      forKey: HamsterAppSettingKeys.rimeInputSchema.rawValue) ?? ""
  {
    didSet {
      UserDefaults.hamsterSettingsDefault.set(
  ...
  // Rime: 颜色方案
  @Published
  var rimeEnableColorSchema: Bool = UserDefaults.hamsterSettingsDefault.bool(
    forKey: HamsterAppSettingKeys.rimeEnableColorSchema.rawValue)
  {
    didSet {
      UserDefaults.hamsterSettingsDefault.set(
  ...
  var rimeColorSchema: String =
    UserDefaults.hamsterSettingsDefault.string(
      forKey: HamsterAppSettingKeys.rimeColorSchema.rawValue) ?? ""
  {
    didSet {
      UserDefaults.hamsterSettingsDefault.set(
