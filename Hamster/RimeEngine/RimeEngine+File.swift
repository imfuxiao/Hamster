...
extension RimeEngine {
    ...
    static var appGroupUserDtaDirectoryURL: URL {
        return shareURL.appendingPathComponent(AppConstants.rimeUserPathName, isDirectory: true)
    }
    ...
    static func syncAppGroupUserDataDirectory() throws {
        let fm = FileManager.default
        let srcPath = appGroupUserDtaDirectoryURL
