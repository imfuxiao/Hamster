...
extension KeyboardAction {
    ...
    var hamsterStandardPressAction: HamsterGestureAction? {
        ...
        case .keyboardType(let type): return { hamsterKeyboardContorller in
    ...
    var hamsterStandardReleaseAction: HamsterGestureAction? {
        ...
        case .primary: return { hamsterInputViewController in
        ...
        case .shift(let currentState): return { hamsterInputViewController in
                {
