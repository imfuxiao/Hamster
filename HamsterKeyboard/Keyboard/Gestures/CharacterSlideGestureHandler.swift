...
class CharacterSlideGestureHandler {
...
//    subsystem: "dev.fuxiao.hamster", category: "CharacterSlideGestureHandler")
//
//  var slideUp: String {
...
//
//  init(
//    config: [String: String] = [:], rimeEngine: RimeEngine?,
//    sensitivity: CharacterSlideSensitivity = .low
//  ) {
...
//    action: KeyboardKit.KeyboardAction, from startLocation: CGPoint, to currentLocation: CGPoint
...
//                  controller?.insertText(candidates[1].text)
