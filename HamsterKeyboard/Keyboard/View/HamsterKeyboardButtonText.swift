...
struct HamsterKeyboardButtonText: View {
    ...
    public init(
        ...
        self.init(buttonExtendCharacter: buttonExtendCharacter, text: text, isInputAction: action.isInputAction, showExtendArea: false)
    }
    ...
    public init(
        ...
        self.init(buttonExtendCharacter: buttonExtendCharacter, text: text, isInputAction: isInputAction, showExtendArea: false)
    }
