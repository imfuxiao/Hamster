//
//  HamsterScrollViewGestureButton.swift
//  Hamster
//
 ...
 */
public struct HamsterScrollViewGestureButton<Label: View>: View {
  /**
...
public extension HamsterScrollViewGestureButton {
...
private extension HamsterScrollViewGestureButton.Style {
...
private extension View {
  ...
  func withDragGestureActions<Label: View>(
    for config: HamsterScrollViewGestureButton<Label>.GestureConfiguration,
