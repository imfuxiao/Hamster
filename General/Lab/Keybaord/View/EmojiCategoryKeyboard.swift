//
//  HamsterEmojiCategoryKeyboard.swift
//  Hamster
//
 ...
 */
public struct HamsterEmojiCategoryKeyboard: View {
  /**
...
private extension HamsterEmojiCategoryKeyboard {
  var title: some View {
    EmojiCategoryTitle(
  ...
  var menu: some View {
    HamsterEmojiCategoryKeyboardMenu(
      selection: $selection,
...
struct HamsterEmojiCategoryKeyboard_Previews: PreviewProvider {
