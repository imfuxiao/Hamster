...
public struct KeyboardButtonStyle: Equatable {
  ...
  /**
   ...
   按键的边框样式
   */
  public var border: KeyboardKeyBorderStyle? {
    get {
  ...
  /**
   ...
   按键阴影样式
   */
  public var shadow: KeyboardKeyShadowStyle? {
    get {
  ...
  public init(
    ...
    border: KeyboardKeyBorderStyle? = nil,
    shadow: KeyboardKeyShadowStyle? = nil,
...
public extension KeyboardKeyStyle {
  /**
   ...
   */
  func extended(with style: KeyboardKeyStyle) -> KeyboardKeyStyle {
    var result = self
   ...
   */
  static let spacer = KeyboardKeyStyle(
